...
from fer.classes import Emotion_Classifier
from fer.exceptions import InvalidImage

__author__ = "Nivratti Boyane"
...
class FER(object):
    ...
    def __init__(
        ...
        if not emotion_model:
            ...
            self.__emotion_classifier = Emotion_Classifier(url, token)
    ...
    def detect_emotions(self, img: np.ndarray) -> list:
        ...
        for face_coordinates in face_rectangles:
            ...
            if not self.deployment:
                ...
                labelled_emotions = {
                    emotion_labels[idx]: round(float(score), 3)
